...
#ifndef MOFSFuncTri_H
#define MOFSFuncTri_H

/**
 * Class MOFSFuncTri: To create membership function with triangular form
 */
...
class MOFSFuncTri {
		...
		public:
			...
			MOFSFuncTri();
			~MOFSFuncTri();
			float Calc(float input, float a, float b, bool slope_down);
